...
export interface UIState {
  ...
  variableUsageReloadTrigger: number;
}
...
export const uiState = createModel<RootModel>()({
  ...
  reducers: {
    ...
    setVariableUsageReloadTrigger: (state) => ({
      ...state,
      variableUsageReloadTrigger: state.variableUsageReloadTrigger + 1,
    }),
  },
  effects: (_dispatch) => ({
