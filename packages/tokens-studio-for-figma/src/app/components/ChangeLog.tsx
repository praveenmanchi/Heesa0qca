...
export default function ChangeLog() {
    ...
    return (
        <Box css={{ display: 'flex', flexDirection: 'column', flexGrow: 1, padding: '$4', height: '100%', overflowY: 'auto' }}>
            ...
            <Stack direction="column" gap={3}>
                {logs.length === 0 ? (
                    ...
                    logs.map((log, index) => (
                        <Box key={index} css={{ padding: '$3', borderRadius: '$medium', background: '$bgSubtle', border: '1px solid $borderMuted' }}>
