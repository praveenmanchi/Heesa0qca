...
function Inspector() {
  ...
  function renderInspectView() {
    switch (inspectView) {
      case 'debug': return <InspectorDebugView resolvedTokens={resolvedTokens} selectedMode={selectedMode} />;
      case 'multi': return <InspectorMultiView resolvedTokens={resolvedTokens} tokenToSearch={searchInputValue} selectedMode={selectedMode} />;
      case 'json': return <InspectorJsonView resolvedTokens={resolvedTokens} selectedMode={selectedMode} />;
      default: return null;
    }
  }
