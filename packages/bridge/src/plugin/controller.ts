...
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.SEARCH_VARIABLE_USAGE, asyncHandlers.searchVariableUsage);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.CREATE_CHANGE_LOG_FRAME, asyncHandlers.createChangeLogFrame);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.EXTRACT_VARIABLES_TO_CANVAS, asyncHandlers.extractVariablesToCanvas);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.GET_UXAI_HISTORY, asyncHandlers.getUxaiHistory);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.SET_UXAI_HISTORY, asyncHandlers.setUxaiHistory);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.APPLY_UXAI_CHANGES, asyncHandlers.applyUxaiChanges);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.CALCULATE_VARIABLES_IMPACT, asyncHandlers.calculateVariablesImpact);
AsyncMessageChannel.PluginInstance.handle(AsyncMessageTypes.GENERATE_STYLE_GUIDE, asyncHandlers.generateStyleGuide);
...
figma.on('selectionchange', () => {
  debouncedSendSelectionChange();
});

async function setupDocumentChangeListener() {
