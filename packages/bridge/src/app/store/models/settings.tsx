...
export type GithubExtractConfig = {
  pat?: string;
  owner?: string;
  repo?: string;
  baseBranch?: string;
...
export const settings = createModel<RootModel>()({
  ...
  reducers: {
    ...
    setUISettings(state, payload: SettingsState) {
      ...
      return {
        ...state,
        ...payload,
        inspectDeep: true, // Force to true since the UI checkbox is removed
      };
    },
    ...
    setGithubExtractConfig(state, payload: Partial<GithubExtractConfig>) {
      return {
        ...state,
        githubExtractConfig: {
          ...state.githubExtractConfig,
          ...payload,
        },
      };
    },
    setZeroheightAPIKey(state, payload: string) {
      return {
        ...state,
  ...
  effects: () => ({
    ...
    setGithubExtractConfig: (payload: Partial<GithubExtractConfig>, rootState) => {
      setUI(rootState.settings);
    },
