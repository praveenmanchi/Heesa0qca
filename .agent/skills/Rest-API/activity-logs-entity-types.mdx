---
title: Entity types | Developer Docs
slug: /figma/rest-api/activity-logs-entity-types
---
...
### file\_repo[​](#file_repo "Direct link to file_repo")
...
### idp\_user[​](#idp_user "Direct link to idp_user")
...
An Enterprise internal policy acknowledgement config.
...
Cadence of the policy.

`enabled_at`String

Date and time the policy was enabled.
