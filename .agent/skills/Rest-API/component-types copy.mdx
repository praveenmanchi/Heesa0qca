---
title: Components and styles | Developer Docs
...
These endpoints are specifically for assets published in a team library. To get metadata for local and subscribed components and styles, use [GET /v1/files/:key](/docs/rest-api/file-endpoints/#get-files-endpoint%C3%9F).
...
`containing_frame`[FrameInfo](#frameinfo-type)default: {}
...
### FrameInfo[​](#frameinfo-type "Direct link to FrameInfo")
...
`containingStateGroup`Stringdeprecated
