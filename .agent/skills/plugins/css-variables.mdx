---
title: CSS Variables and Theming | Developer Docs
slug: /figma/plugins/css-variables
---
...
**`-slot`** Pink indicators for slot-related UI elements. Slots allow component designers to define flexible placeholder areas within components where users can insert content.
...
**`--figma-color-bg-slot`** Pink fill color for slot overlays.

**`--figma-color-border-slot`** Pink border color for slot outlines.
